...
export const FeatureProduct = (items) => {
  ...
  return (
    <div className="w-full max-w-[530px] h-[360px] relative flex flex-col items-center justify-center xl:flex-row xl:justify-start mx-auto">
      <div className="xl:flex absolute top-0 right-0 -z-20  ">
        <img src={bgImage} alt="" />
      </div>
      <div className="max-w-[120px] xl:mr-7 xl:max-w-[230px] ">
        <img src={image} alt="" />
      </div>
      <div className="max-w-[180px] text-start mb-10 flex flex-col justify-center">
